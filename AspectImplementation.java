...
public class AspectImplementation implements Aspect {
    ...
    // constructor
    public AspectImplementation(Class<?>[] targets, Map<Method, Runnable> beforeAdviceMap, Map<Method, Runnable> afterAdviceMap, Map<Method, Runnable> aroundAdviceMap) {
    ...
    public static class AspectBuilder implements Builder {
        ...
        @Override
        public Aspect build() {
            return new AspectImplementation(targets, beforeAdviceMap, afterAdviceMap, aroundAdviceMap);
        }
    }
